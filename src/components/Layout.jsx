    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10">
        <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/75 backdrop-blur-xl">
          <div className="flex w-full items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/5 p-2 text-slate-200 md:hidden"
            >
          ...
          <AnimatePresence initial={false}>
            {mobileOpen && (
              <motion.div
                ...
                className="border-t border-white/10 bg-slate-950/85 px-4 py-3 backdrop-blur-xl md:hidden"
              >
        ...
        <footer className="border-t border-white/10 bg-slate-950/40">
          <div className="flex w-full flex-col gap-3 px-4 py-4 text-sm text-slate-400 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
            <div className="flex flex-col gap-1">
              <p className="text-slate-200">MediCode AI</p>
              <p>Dark-tech frontend demo for audit-ready clinical coding workflows.</p>
            </div>
